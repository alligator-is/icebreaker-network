...
module.exports = function (params) {
  ...
  var o = createSocket({ 
    address: params.host || params.localAddress, 
    port: params.port, 
    loopback: params.loopback,
    reuseAddr: params.reuseAddr,
    multicast: params.multicast,
    unicast: params.unicast,
    broadcast: params.broadcast, multicastTTL: params.multicastTTL, bindingPort: params.localPort
  })
  ...
  source.push = function (buf, port, host) {
    ...
    if (_.isString(buf)) buf = Buffer.from(buf, 'utf8')
