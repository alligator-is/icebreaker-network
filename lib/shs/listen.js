...
module.exports = function listen(params) {
    ...
    var create = SHS.createServer({publicKey:util.decode(util.encode(util.decode(params.keys.publicKey,params.encoding),'base64'),'base64'),
    secretKey:util.decode(util.encode(util.decode(params.keys.secretKey,params.encoding),'base64'),'base64')},
    params.authenticate,new Buffer(cl.crypto_hash_sha256(new Buffer(params.appKey)),'base64'),params.timeout)
   
    var source=_(protocol=protocol(params),asyncMap({
        ready:function(e,cb){
